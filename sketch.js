...
const options = {
  ...
  zoom: 10, //initial zoom level - 10 shows all locations in Surrey
...
function draw(){
  ...
  let pos4 = myMap.latLngToPixel(51.431480, -0.515525); //Staines Maybe put into an ARRAY
  ...
  textFont('Arial')
  textSize(20);
  text('Woking',pos2.x, pos2.y);

  fill(0);
  ellipse(pos3.x, pos3.y, 15, 15);
  textFont('Arial')
  textSize(20);
  text('Dorking',pos3.x, pos3.y);

  fill(0);
  ellipse(pos4.x, pos4.y, 15, 15);
  textFont('Arial')
  textSize(20);
  text('Staines',pos4.x, pos4.y);
